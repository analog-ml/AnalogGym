...
class OutputParser2(DeviceParams):  
    ...
    def dcop(self, file_name:str)-> dict[str, dict]:
        """DC Operating Point analysis result parser

        Args:
            file_name (str): path to the .OP file generated by SPICE simulation. (e.g. AMP_NMCF_op in case of AMP_NMCF)

        Returns:
            dict: A dictionary containing the operating point parameters for each device in the circuit.
            The keys are device names, and the values are dictionaries of parameters.
            ...
            Examples: 
            {
                'M0':{'vds': ... , 'gds': ...},'M1':{},'M2':{},'M3':{},'M4':{},'M5':{},'M6':{},'M7':{},'M8':{}, 'M9':{},'M10':{},'M10':{},'M11':{},
